...
# export OMPI_MCA_btl=vader,self,cuda
export OMPI_MCA_btl=vader,self

# Run program
# srun -n 4 julia --project=$WORK/MPIGPUVicsek ./test_script.jl
srun --ntasks=2 --tasks-per-node=2 --hint=nomultithread julia --project=$WORK/MPIGPUVicsek ./test_script.jl
