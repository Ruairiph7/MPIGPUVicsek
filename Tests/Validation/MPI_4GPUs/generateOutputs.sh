...
#SBATCH --job-name=mpi_validation_4gpus
...
# Run program
srun --ntasks=$SLURM_NTASKS --tasks-per-node=$SLURM_TASKS_PER_NODE --hint=nomultithread julia --project=$WORK/MPIGPUVicsek ./generateOutputs.jl
