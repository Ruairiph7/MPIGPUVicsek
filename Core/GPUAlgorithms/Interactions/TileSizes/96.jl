@kernel function calculate_interactions_kernel_96!(
    θ_updates,
    ...
    if group_idx <= max_group_idx
        ...
        shared_tile = @localmem Particle 96
            ...
            for nghbr in Int32(1):Int32(9)
                ...
                if nghbr_count > Int32(0)
                    ...
                    while tile_offset < nghbr_count
                        ...
                        #Fix tile size to 96, or number of remaining particles if < 96
                        this_tile_size = min(Int32(96), nghbr_count - tile_offset)
