@kernel function calculate_interactions_kernel_32!(
    θ_updates,
    ...
    if group_idx <= max_group_idx
        ...
        shared_tile = @localmem Particle 32
            ...
            for nghbr in Int32(1):Int32(9)
                ...
                if nghbr_count > Int32(0)
                    ...
                    while tile_offset < nghbr_count
                        ...
                        #Fix tile size to 32, or number of remaining particles if < 32
                        this_tile_size = min(Int32(32), nghbr_count - tile_offset)
