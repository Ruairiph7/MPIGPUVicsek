...
function get_updates_bpc!(θ_updates, particles, cells_data, cell_list_params, num_particles, numerical_params, min_cell_width)
    ...
    calculate_θ_updates_bpc!(θ_updates, cells_data, cell_list_params, num_particles, numerical_params, min_cell_width)
